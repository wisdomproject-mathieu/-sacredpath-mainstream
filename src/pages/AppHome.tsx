  ...
  return (
    <Layout>
      <div className="max-w-6xl mx-auto">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start lg:items-center mb-10 md:mb-16">
          ...
          <aside className="relative">
            <div className="lg:sticky lg:top-8">
              <div className="bg-card rounded-[24px] border border-white/5 shadow-soft p-4 sm:p-6 md:p-8 relative overflow-hidden">
